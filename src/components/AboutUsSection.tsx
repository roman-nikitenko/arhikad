  ...
  return (
    <section ref={aboutSectionRef} className="section-md md:px-0 md:py-3 px-4 ">
      ...
      >
        ...
        <p className="md:text-base w-full text-xs">Ласкаво просимо до Архікад-НВ, де інновації зустрічаються з традиціями у світі архітектури та землевпорядкування. З пристрастю до роботи та прагненням до вдосконалення ми створюємо простори, які надихають і слугують довговічно вже понад 12 років. Наша подорож почалася з простого бачення: створити комфортне середовище, яке покращить людське життя.</p>
