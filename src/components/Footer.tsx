      ...
      <div className="flex flex-col-reverse  lg:flex-row gap-7 lg:gap-0 lg:justify-between">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-x-2 cursor-pointer">
            <img loading="lazy" className="size-5" src={email} alt="contact"/>
            <a href="mailto:arhicadnv@ukr.net">arhicadnv@ukr.net</a>
          </div>
          <div className="flex items-center gap-x-2 cursor-pointer">
            <img loading="lazy" className="size-5" src={phone} alt="contact"/>
            <a href="tel:+380980055404">{phoneNumber}</a>
          </div>
          <div className="flex items-center gap-x-2 cursor-pointer">
            <img loading="lazy" className="size-5" src={point} alt="contact"/>
